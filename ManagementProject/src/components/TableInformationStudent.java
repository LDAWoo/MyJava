...
import components.TableCellRenderer;
...
public class TableInformationStudent extends JTable {

	private DefaultTableModel tableModel;
	private JTextArea textArea;

	public TableInformationStudent() {
		...
		setModel(new DefaultTableModel(new Object[][] {}, new String[] { "Thông tin học tập" }));
...
//		for (ModelNotification data : dao.SelectAll()) {
//			Object[] rows = new Object[1];
//			rows[0] = data.getNotification();
