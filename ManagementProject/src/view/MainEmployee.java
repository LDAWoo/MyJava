...
public class MainEmployee extends JFrame {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					MainEmployee frame = new MainEmployee(email,role);
	...
	public MainEmployee(String email,String role) {
		this.role = role;
		this.email = email;
		setUndecorated(true);
	...
	public void action() {
		DialogSettingEmployee setting = new DialogSettingEmployee(MainEmployee.this,height);
		DialogHelp help = new DialogHelp(MainEmployee.this);
		...
		addMouseMotionListener(new MouseAdapter() {			
			...
			public void mouseDragged(MouseEvent e) {
				...
				xScreen = currCoords.x - mouseDownCompCoords.x + 525; 
