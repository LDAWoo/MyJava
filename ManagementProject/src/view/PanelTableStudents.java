	...
	public void Action() {
		...
		btnAdd.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(dao.Insert(new ModelStudents(st.getID(), new ModelStudent(codeStudent), new ModelCourses(codeCourse), new ModelLearners(codeLearner), new ModelName(), new ModelSex(), new ModelAge(), new ModelGrade(grade)))>0){	
					getDialogPosition();
	...
	public void initData() {
		for (ModelStudents data : datas) {
			table.addRow(new ModelStudents(data.getID(), new ModelStudent(data.getCodeStudent().getCodeStudent()),
					new ModelCourses(data.getCodeCourse().getCodeCourse()),
					new ModelLearners(data.getCodeLearner().getCodeLerner()),
