...
public class AnimationButtonAction extends JButton{
	...
	public AnimationButtonAction() {
		init();
	}
	
	public AnimationButtonAction(String text) {
		super(text);
		init();
	}
	
	public AnimationButtonAction(Icon icon, String name) {
		super(name);
		setIcon(icon);
		init();
