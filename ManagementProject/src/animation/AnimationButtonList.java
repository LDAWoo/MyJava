...
public class AnimationButtonList extends JButton{
	...
	public AnimationButtonList() {
		init();
	}
	
	public AnimationButtonList(String text) {
		super(text);
		init();
	}
	
	public AnimationButtonList(Icon icon, String name) {
		super(name);
		setIcon(icon);
		init();
