...
public class AnimationButtonSave extends JButton{
	...
	public AnimationButtonSave() {
		init();
	}
	
	public AnimationButtonSave(String text) {
		super(text);
		init();
	}
	
	public AnimationButtonSave(Icon icon, String name) {
		super(name);
		setIcon(icon);
		init();
