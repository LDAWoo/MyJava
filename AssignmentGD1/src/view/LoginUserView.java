...
public class LoginUserView extends JFrame {
	...
	public void Login() {
		ManagerUserAndGradeView andGradeView = new ManagerUserAndGradeView();
		if(Validate()) {
		String username = this.textFieldUser.getText();
		String password = new String(this.passwordField.getPassword());
		String Admin = "Admin";
		...
		if(this.userDAO.selectAll(username, password).equals(Admin)) {	
			...
			andGradeView.getLblRole().setText(Admin);
			andGradeView.setVisible(true);
			andGradeView.setLocationRelativeTo(null);
			
		
		}else if(this.userDAO.selectAll(username, password).equals(User)) {
			this.setVisible(false);
			andGradeView.getLblRole().setText(User);
			andGradeView.setVisible(true);
			andGradeView.setLocationRelativeTo(null);
		}
		else {
