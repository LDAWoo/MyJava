...
public class ManagerStudentView extends JFrame {
	...
	public ManagerStudentView() {
		...
		scrollPane_1.setBorder(new LineBorder(new Color(0, 0, 139), 2));
		...
		jLabelImg.setBorder(new LineBorder(new Color(0, 0, 139), 2));
		...
		lblAddress.setBounds(249, 384, 239, 18);
	...
	public void Save() {
		...
		if(this.managerStudentDAO.Insert(msm)) {
			...
			this.lblCode1.setText("<Mã nhân viên không được trùng>");
			this.textFieldCode.requestFocus();
		}
		}
