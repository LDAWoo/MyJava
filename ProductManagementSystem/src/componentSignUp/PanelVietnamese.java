...
public class PanelVietnamese extends JPanel {

	
	public PanelVietnamese() {
		setLayout(null);
		...
		JCheckBox checkBox = new JCheckBox("Tôi đồng ý với Điều khoản Dịch Vụ và Chính Sách Bảo Mật");
		checkBox.setOpaque(false);
		checkBox.setForeground(new Color(150, 150, 150));
		checkBox.setFont(new Font("Segoe UI", Font.PLAIN, 14));
		checkBox.setFocusPainted(false);
		
		JButton btnSignUpNow = new JButton("Đăng Ký Ngay");
