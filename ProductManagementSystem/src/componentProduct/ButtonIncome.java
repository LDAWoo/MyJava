...
public class ButtonIncome extends JButton {
	...
	public ButtonIncome() {
		...
		lblIcon.setIcon(new ImageIcon(ButtonIncome.class.getResource("/icon/curve-white.png")));
		
		JLabel lblCustomers = new JLabel("Thu nhập");
		lblCustomers.setFont(new Font("Roboto", Font.PLAIN, 13));
		lblCustomers.setForeground(color1);
		
		JLabel lblCountCustomers = new JLabel("1000K");
