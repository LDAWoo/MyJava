...
public class GradeStudentView extends JFrame {
	...
	public GradeStudentView() {
		...
		panel1.setBorder(new LineBorder(new Color(0, 0, 128)));
		...
		btnFirst.setBorder(new LineBorder(new Color(0, 0, 128)));
		panel2.add(btnFirst);

		btnPrev = new JButton("", this.img.ImagePrev());
		btnPrev.setBorder(new LineBorder(new Color(0, 0, 128)));
		panel2.add(btnPrev);

		btnNext = new JButton(" ", this.img.ImageNext());
		btnNext.setBorder(new LineBorder(new Color(0, 0, 128)));
		panel2.add(btnNext);

		btnLast = new JButton("", this.img.ImageLast());
		btnLast.setBorder(new LineBorder(new Color(0, 0, 128)));
		panel2.add(btnLast);
		...
		panel5.setBorder(new LineBorder(new Color(0, 0, 128)));
