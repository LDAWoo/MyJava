...
public class Card extends JPanel {
	...
	DataAccount data = new DataAccount(this);
	...
	public Card() {
		...
		lblIcon.setIcon(this.img.IconUser());
		add(lblIcon);
		...
		lblValues.setBounds(45, 127, 69, 21);
		add(lblValues);
		...
		add(lblDescription);
		color1 = new Color(186,123,247);
		color2 = new Color(167,94,236);
		data.AmountAccoutAdmin();
	}
